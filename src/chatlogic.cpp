...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    //std::unique_ptr<ChatBot>    localChatBot = std::make_unique<ChatBot>("../images/chatbot.png");
    localChatBot.SetChatLogicHandle(this);
//    localChatBot->SetChatLogicHandle(this);
//    this->SetChatbotHandle(localChatBot.get());
    this->SetChatbotHandle(&localChatBot);
